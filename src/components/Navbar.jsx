    ...
    <a
      ...
      className={`text-sm font-medium transition-colors border-b-2 ${
        activeLink === link.href
          ? "text-blue-600 border-blue-600" // active link: color + underline
          : "text-gray-600 border-transparent hover:text-gray-900 hover:border-gray-400" // inactive: no underline, hover effect
      }`}
    >
      {link.label}
    </a>
